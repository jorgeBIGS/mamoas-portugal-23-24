...
train_cfg = dict(max_epochs=24, type='EpochBasedTrainLoop', val_interval=7)
...
val_dataloader = dict(
    ...
    sampler=dict(shuffle=False, type='DefaultSampler'))
val_evaluator = dict(
    ann_file='data/mamoas-30/annotations/all.json',
    backend_args=None,
    format_only=False,
    metric='bbox',
    type='CocoMetric')
...
work_dir = 'results_loo_30/cascade_rcnn//analyze'
