...
python tools/test.py ${CONFIG_FILE} ${WORK_DIR}/epoch_24.pth --work-dir=${WORK_DIR} --out=${WORK_DIR}/preds.pkl --show-dir=vis_preds \
...
python tools/analysis_tools/analyze_results.py ${CONFIG_FILE} ${WORK_DIR}/preds.pkl  ${WORK_DIR}/analyze --show-score-thr=0.5
...
python tools/analysis_tools/confusion_matrix.py ${CONFIG_FILE} ${WORK_DIR}/preds.pkl  ${WORK_DIR} --score-thr=0.5 --tp-iou-thr=0.5 --color-theme=Blues
...
python tools/analysis_tools/eval_metric.py ${CONFIG_FILE} ${WORK_DIR}/preds.pkl 